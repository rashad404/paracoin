...
@section('content')
    ...
    <section class="coin-section buy-section">
        @include('includes.breadcrumbs')
        
        <div class="mb-4 mt-3 md:flex md:items-center md:justify-between">
            <div class="flex-1 min-w-0">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">@lang('text.'.$pageTitle)</h2>
            </div>
        </div>
        <div class="box-container">
            ...
            <p class="currentPrice">
                @lang('text.Current Price') <span class="amount">{{number_format($currentPrice, 6)}}</span> {{config('coin.currency')}}
            </p>
            <p>* Note: {{config('coin.name')}} @lang('text.amount is estimated amount. Final amount will be calculated during the transaction.')</p>
            <form id="payment-form">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        {{Form::number('amount', null, [
                            'id'=>'amount',
                            'class'=>'form-control', 
                            'placeholder'=> config('coin.currency').' '.__('text.Amount'), 
                            'step' => '0.0000001', 
                            'min'=>1, 
                            'max'=>5,
                            'required' => 'required'
                        ...
                        <div class="col-2">
                        <div class="coin-symbol">{{config('coin.currency')}}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-2">
                        <div class="coin-symbol">{{config('coin.symbol')}}</div>
                        </div>
                    </div>
                </div>
