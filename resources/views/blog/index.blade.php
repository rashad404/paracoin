    ...
    <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
        ...
        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
          <div class="flex-1">
            <p class="text-sm font-medium text-indigo-600">
              <a href="/blog/view" class="hover:underline"> Article </a>
            </p>
            <a href="/blog/view" class="block mt-2">
          ...
          <div class="mt-6 flex items-center">
            ...
            <div class="ml-3">
              <p class="text-sm font-medium text-gray-900">
                <a href="/blog/view" class="hover:underline"> Roel Aufderehar </a>
              </p>
      ...
      <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
          <div class="flex-1">
            <p class="text-sm font-medium text-indigo-600">
              <a href="/blog/view" class="hover:underline"> Video </a>
            </p>
            <a href="/blog/view" class="block mt-2">
          ...
          <div class="mt-6 flex items-center">
            ...
            <div class="ml-3">
              <p class="text-sm font-medium text-gray-900">
                <a href="/blog/view" class="hover:underline"> Brenna Goyette </a>
              </p>
              <div class="flex space-x-1 text-sm text-gray-500">
      ...
      <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="flex-1 bg-white p-6 flex flex-col justify-between">
          <div class="flex-1">
            <p class="text-sm font-medium text-indigo-600">
              <a href="/blog/view" class="hover:underline"> Case Study </a>
            </p>
            <a href="/blog/view" class="block mt-2">
          ...
          <div class="mt-6 flex items-center">
            ...
            <div class="ml-3">
              <p class="text-sm font-medium text-gray-900">
                <a href="/blog/view" class="hover:underline"> Daniela Metz </a>
              </p>
              <div class="flex space-x-1 text-sm text-gray-500">
